(define (domain first-response)
 ...
 (:action senseFIREFIRE
  ...
  (:action senseFIREMEDICAL
  :parameters (?u - medical_unit ?l ?l1 - location)
 ...
 (:action senseHEALTHYMEDICAL
  :parameters (?u - medical_unit ?l - location ?v - victim)
  :precondition (and (medical-unit-at ?u ?l) 
                (victim-at ?v ?l))
  :observe (victim-status ?v healthy)
 )
 
 (:action senseHURTMEDICAL
  :parameters (?u - medical_unit ?l - location ?v - victim)
  :precondition (and (medical-unit-at ?u ?l) 
                (victim-at ?v ?l))
  :observe (victim-status ?v hurt)
 )
