(define (domain faults)
 ...
 (:constants  f1 f2 f3 f4 f5 - tfault
 ...
 (:action perform-operation-1-fault
  ...
  :precondition (and  (not-fault f1) (not-fault f2) (not-fault f3) (not-fault f4) (not-fault f5) (not-completed ?o))
 ...
 (:action perform-operation-2-fault
  :parameters (?o - operation)
  :precondition (and  (fault f1) (not-fault f2) (not-fault f3) (not-fault f4) (not-fault f5) (not-completed ?o))
  :effect (and (completed ?o) (not (not-completed ?o))
 ...
 (:action perform-operation-3-fault
  :parameters (?o - operation)
  :precondition (and  (fault f1) (fault f2) (not-fault f3) (not-fault f4) (not-fault f5) (not-completed ?o))
  :effect (and (completed ?o) (not (not-completed ?o))
 ...
 (:action perform-operation-4-fault
  :parameters (?o - operation)
  :precondition (and  (fault f1) (fault f2) (fault f3) (not-fault f4) (not-fault f5) (not-completed ?o))
  :effect (and (completed ?o) (not (not-completed ?o))
 ...
 (:action perform-operation-5-fault
  :parameters (?o - operation)
  :precondition (and  (fault f1) (fault f2) (fault f3) (fault f4) (not-fault f5) (not-completed ?o))
  :effect (and (completed ?o) (not (not-completed ?o))
 ...
 (:action finish
  :precondition (and  (completed o1) (completed o2) (completed o3) (completed o4) (completed o5) (completed o6) (completed o7) (completed o8) (completed o9) (completed o10) (not-last-fault f5))
  :effect (made)
 )
)
