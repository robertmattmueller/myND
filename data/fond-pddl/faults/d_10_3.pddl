(define (domain faults)
 ...
 (:action perform-operation-1-fault
  ...
  :precondition (and  (not-fault f1) (not-fault f2) (not-fault f3) (not-completed ?o))
 ...
 (:action perform-operation-2-fault
  :parameters (?o - operation)
  :precondition (and  (fault f1) (not-fault f2) (not-fault f3) (not-completed ?o))
  :effect (and (completed ?o) (not (not-completed ?o))
 ...
 (:action perform-operation-3-fault
  :parameters (?o - operation)
  :precondition (and  (fault f1) (fault f2) (not-fault f3) (not-completed ?o))
  :effect (and (completed ?o) (not (not-completed ?o))
 ...
 (:action finish
  :precondition (and  (completed o1) (completed o2) (completed o3) (completed o4) (completed o5) (completed o6) (completed o7) (completed o8) (completed o9) (completed o10) (not-last-fault f3))
  :effect (made)
 )
)
