...
public class TryVarOrder {
  ...
  void initBDDFactory(String s) {
    try {
      ...
      System.err.println("Exception occurred while initializing BDD factory: "
  ...
  void destroyBDDFactory() {
    if (bdd != null) {
      ...
      try {
        ...
        System.err.println("Exception occurred while destroying BDD factory: "
            + x.getLocalizedMessage());
        x.printStackTrace();
      }
      bdd = null;
  ...
  void setBDDError(int code) {
    ...
    try {
      ...
      System.err.println("Exception occurred while setting error for BDD factory: "
          + x.getLocalizedMessage());
      x.printStackTrace();
    }
  }
  ...
  void initBDDOperation() throws Exception {
    ...
    m =
        bddop_class.getMethod("setFilenames",
  ...
  public TryVarOrder(int nodeTableSize, int cacheSize, int maxIncrease, long bestTime,
      long delayTime) {
