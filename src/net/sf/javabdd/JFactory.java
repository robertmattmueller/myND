...
public class JFactory extends BDDFactory {
    ...
    private class bdd extends BDD {
         ...
         * 
         * <p>Finds one random satisfying variable assignment. Finds a minterm in this BDD.
         ...
         * are undefined in this BDD - are set randomly.
         * 
         * <p>Compare to bdd_satoneset_random.</p>
         * 
    ...
    int satoneset_rec_random(int r, int var) {
        ...
        if (LEVEL(r) < LEVEL(var)) {
        	/* Must not occur since BDD r does not contain variables which are
        	 * not in varset var. */
        	assert false; 
            if (LOW(r) != 0 && HIGH(r) != 0) {
