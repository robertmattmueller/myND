...
public class SymbolicOperator extends Operator {
	 ...
	 */
	public SymbolicOperator(String name, SymbolicCondition precondition, BDD effect, Set<Pair<Integer, Integer>> observation, boolean isAbstracted, int cost) {
	...
	public SymbolicOperator(String name, SymbolicCondition precondition, BDD effect, Set<Pair<Integer, Integer>> observation, boolean isAbstracted, boolean isDeterminized, int cost) {
