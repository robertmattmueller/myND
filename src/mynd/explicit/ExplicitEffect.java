...
/**
 * An effect consists of a condition <tt>cond</tt>, which is a list of variable-value pairs, an
 * affected variable <tt>var</tt>, and a new value <tt>val</tt> for <tt>var</tt>. Thus, it is
 * basically a horn clause. Effects are normalized, i.e., there are no nested conditions.
 *
...
public class ExplicitEffect {
  ...
  /**
   * Checks whether this effect is enabled in a given variable assignment, i.e., if its condition is
   * satisfied.
   *
