...
public final class NamedOptionDef extends OptionDef {
  ...
  /**
   * @deprecated multi-valuedness as option definition does not make sense. It's driven by the
   *             setter.
   */
  @Deprecated
  ...
  public NamedOptionDef(Option o) {
    super(o.usage(), o.metaVar(), o.required(), o.help(), o.hidden(), o.handler(), false, o
        .groups(), o.showDefault());
