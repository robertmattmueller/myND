...
/**
 * Run-time copy of the Option or Argument annotation. By definition, unnamed options are arguments
 * (and instances of this class). Named options are actually a subclass.
 *
 * @author Mark Sinke
 */
public class OptionDef {
  ...
  public OptionDef(Argument a, boolean forceMultiValued) {
    this(a.usage(), a.metaVar(), a.required(), false, a.hidden(), a.handler(), a.multiValued()
        || forceMultiValued, new String[0], false);
  }

  protected OptionDef(String usage, String metaVar, boolean required, boolean help, boolean hidden,
      Class<? extends OptionHandler> handler, boolean multiValued, String[] group,
      boolean showDefault) {
    this.usage = usage;
