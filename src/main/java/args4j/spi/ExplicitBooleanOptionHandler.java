...
/**
 * Boolean {@link OptionHandler} that (unlike the standard {@link BooleanOptionHandler} allows
 * values to be set to false explicitly (using e.g. '-myOpt false') rather than only returning false
 * when the option is <em>omitted</em>.
 */
