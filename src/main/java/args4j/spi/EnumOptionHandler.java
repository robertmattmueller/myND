...
public class EnumOptionHandler<T extends Enum<T>> extends OptionHandler<T> {
  ...
  public EnumOptionHandler(CmdLineParser parser, OptionDef option, Setter<? super T> setter,
      Class<T> enumType) {
