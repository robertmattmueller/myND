 ...
 *        When I say "component", I mean a field that can hold multiple values (such as
 *        {@link Collection} or array). This should refer to its component time.
 *
 *        {@link Setter} implementations abstract away multi-value-ness by allowing
 *        {@link OptionHandler} to invoke its {@link Setter#addValue(Object)} multiple times.
 *
...
public abstract class OptionHandler<T> {
   ...
   *        arguments of the option if necessary.
   *
   *        The object is valid only during the method call.
   *
   * @return The number of arguments consumed. (For example, returns {@code 0} if this option
   ...
   *
   * The value returned by this method can be a reference in the {@code ResourceBundle}, if one was
   * passed to {@link CmdLineParser}.
   *
  ...
  /**
   * Get string representing usage for this option, of the form "name metaval", e.g. "-foo VALUE" or
   * "--foo VALUE"
   *
