 ...
 *
 * <p>
 * For example, we use this to let the caller specify which options are printed, and which ones
 * aren't.
 *
...
public interface OptionHandlerFilter {
  /**
   *
   * @param o Never {@code null}. Internally options (like <samp>-r</samp>) and arguments (others)
   *        are treated uniformly as {@link OptionHandler}. See {@link OptionDef#isArgument()} to
   *        distinguish them.
