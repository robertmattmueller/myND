...
public class Connector {
  ...
  public static boolean consistencyTestForConnectors(Collection<Node> nodes) {
    // Each outgoing connector has to be an incoming connector of the corresponding node.
    ...
    // Each incoming connector has to be an outgoing connector of the corresponding node.
